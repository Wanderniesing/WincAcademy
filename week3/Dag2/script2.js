...
const getRandomSucceedingOrFailingPromise = id => {
  ...
  let promiseShouldSucceed = getRandomSucceedingOrFailingPromise;
  // This gets some semi-random amound of seconds under the 5seconds:
  let randomMillisecond = setTimeout;
